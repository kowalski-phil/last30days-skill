...
QUICK_SOURCE_PRIORITY = {
    "factual": ["hackernews", "reddit", "x", "youtube", "linkedin"],
    "product": ["youtube", "reddit", "x", "linkedin"],
    "concept": ["hackernews", "reddit", "x", "linkedin", "youtube"],
    "opinion": ["reddit", "x", "linkedin", "youtube", "hackernews"],
    "how_to": ["youtube", "reddit", "x", "hackernews", "linkedin"],
    "comparison": ["reddit", "x", "linkedin", "hackernews", "youtube"],
    "breaking_news": ["x", "reddit", "hackernews", "youtube", "polymarket"],
    "prediction": ["polymarket", "x", "hackernews", "reddit", "youtube"],
}
SOURCE_PRIORITY = {
    "factual": ["hackernews", "reddit", "x", "linkedin", "youtube"],
    "product": ["youtube", "reddit", "x", "linkedin", "hackernews"],
    "concept": ["hackernews", "reddit", "x", "linkedin", "youtube"],
    "opinion": ["reddit", "x", "linkedin", "youtube", "hackernews"],
    "how_to": ["youtube", "reddit", "x", "linkedin", "hackernews"],
    "comparison": ["reddit", "x", "linkedin", "hackernews", "youtube"],
    "breaking_news": ["x", "reddit", "hackernews", "youtube", "polymarket"],
    "prediction": ["polymarket", "x", "hackernews", "reddit", "youtube"],
}
...
SOURCE_CAPABILITIES = {
    ...
    "x": {"discussion", "social"},
    "linkedin": {"discussion", "social", "professional"},
